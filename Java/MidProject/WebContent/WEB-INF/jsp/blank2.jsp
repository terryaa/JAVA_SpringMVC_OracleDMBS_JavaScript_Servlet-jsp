        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				<h3>
					<i class="fa fa-angle-right"></i> 관리자 대시보드
				</h3>
				...
				<div class="col-lg-6">
					<div class="content-panel">
						<div class="btn-group">
							<!-- 							<h4> -->
							<!-- 								<i class="fa fa-angle-right"></i> 총 판매금액 (단위:원)          -->
							<!-- 							</h4> -->
...
<!-- $(document).ready(function () { var dataPoints = []; var dataPoints1 = -->
<!-- []; var dataPoints2 = []; $.getJSON(“jsonData.json”, function (data) { -->
<!-- for (var i = 0; i <= data.length - 1; i++) { for( var j = 0; j < -->
<!-- data[i].length-1; j++){ dataPoints.push( { x: data[i][0], y: -->
<!-- data[i][1]}); dataPoints1.push({ x: data[i][0], y: data[i][2]}); -->
<!-- dataPoints2.push({ x: data[i][0], y: data[i][3]}); } } chart = new -->
<!-- CanvasJS.Chart("chartContainer",{ axisX: { interval: 1 }, data: [ { -->
<!-- type: "column", dataPoints : dataPoints }, { type: "column", dataPoints -->
<!-- : dataPoints1 }, { type: "column", dataPoints : dataPoints2 } ] }); -->
<!-- chart.render(); }); }); jsondata -->
